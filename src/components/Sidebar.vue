<template>
        <!-- sidebar -->
      <div class="allll margin-top-[100px]">
        <div>
        <p class="font-semibold text-3xl">GoBlog.</p>
        <div class="font-normal mt-24">
            <p><router-link to="/">Личный блог</router-link></p>
            <p class="mt-6"><router-link to="/posts">Посты</router-link></p>
            <p class="mt-6">Категории</p>
            <p class="mt-6">Медия</p>
            <p class="mt-6">Пользователи</p>
